export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx5c5f3ace4802262c",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5ae183f80cb070349ffee83685733cf6",
  ...
  USERS: [
    {
      ...
      id: "owI5U6PS3_I9nNCTJtFmXL9ELGF8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "NqIsjzRp3OBejbK8QpFRkUKYhqLkrQcfbVEIqO9vmT0",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "湘潭",
